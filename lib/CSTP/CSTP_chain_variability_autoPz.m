function Save=CSTP_chain_variability(E,Flash,Y,Window,Delays,winElec,winTime,RND,nbTarget)
...
Save{10}=P;
[Bs Bt As At Class eigV]=CSTPover(X,Y,P,[],winElec,winTime);
Save{11}=applyCSTP(P,Bs,Bt,As,At,Class);%
