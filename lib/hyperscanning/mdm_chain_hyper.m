function [AUC, scores,distances, ConfM, Perfclassif,EIG,RND, P1, SHUF]=mdm_chain_hyper(ALLdata,Parameters,P)
%INPUTS
...
%%
       if P.nusers==2
        BImapping=[P.BImap P.BImap+32];
            ...
            [Xtraining Ytraining Xtest Ytest RND]=Generate_Training_Test_Set(X(:,:,NoArte),Y(NoArte),Ratio,P.RND);
