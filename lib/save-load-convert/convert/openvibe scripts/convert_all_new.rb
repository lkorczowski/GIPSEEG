...
SCENARIO_PATH = 'D:/data/erwan/gdf_converter.xml'
DATA_PATH='D:/data/Hyperscanning/MARTI/Groups' #put the path where the script will search and convert ALL the .ov files (can be long)
MODE = "--play-fast" 
...
puts env["destfile"]
Openvibe.setEnv(env)
Openvibe.setOutput("NUL") #"NUL" for window, "/dev/null" for linux
Openvibe.start 
