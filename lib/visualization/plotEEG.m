function h=plotEEG(sig,Scale,fs,LABELS,FontSize,Color,Marker,LineStyle,LineWidth,offset)
%h=plotEEG(sig,Scale,fs,LABELS,FontSize,Color,Marker,LineStyle,LineWidth,offset)
% *** History: 19-Mar-2015
...
t = (offset:(offset+NbSamples-1))./fs;
