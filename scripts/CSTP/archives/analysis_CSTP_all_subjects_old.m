...
%%prepare data
        ...
        winTime=[5:80]; %time window used for latency calculation and Pz
        %winElec=[];
        %winTime=[];
        Ts=size(E,2);
        time1=40; %in second
...
%PLOTX=mean(X(:,:,Y==1),3);
PLOTX=Save{10}(:,:,end);
info=['ss' num2str(Subjects) ' EA'];
Scale=FindScaling(PLOTX,winElec,winTime);
    case 2
%PLOTX=Xcstp(:,:,Y==1);
PLOTX=mean(Save{3}{Pzind}(:,:,end),3);
info=['ss' num2str(Subjects) ' CSTP(' num2str(PZs(Pzind)) ')'];
...
spaceplots
saveas(hfig,['D:\Mes Documents GIPSA\MATLAB\figures\CSPT\final\EAvsCSTP\3Subject_' num2str(Subjects) '.tiff'])
saveas(hfig,['D:\Mes Documents GIPSA\MATLAB\figures\CSPT\final\EAvsCSTP\3Subject_' num2str(Subjects) '.fig'])
...
info='';
    case 2
PLOTX=Xcstp(:,:,Y==1);
info=['CSTP(' num2str(PZs(Pz1)) ')'];

    case 3
PLOTX=Xcsp(:,:,Y==1);
info=['CSP(' num2str(PZs(Pz2)) ')'];

    case 4
PLOTX=Xctp(:,:,Y==1);
info=['CTP(' num2str(PZs(Pz3)) ')'];
...
ylim([0 6]);grid on;
ylabel('(C)','FontSize',FontSize,'fontname','times new roman','FontAngle','italic');set(gca,'YtickLabel',[])
xticks = linspace(0, 1.01, numel(xticklabels));
set(gca, 'XTick', xticks, 'XTickLabel', [],'FontSize',FontSize,'fontname','times new roman','FontAngle','italic')
...
%axis([1 1 1 1]);
set(gca,'YtickLabel',[])
ylabel('(D)','FontSize',FontSize,'fontname','times new roman','FontAngle','italic');
...
ylim([0 15]);grid on;
ylabel('(E)','FontSize',FontSize,'fontname','times new roman','FontAngle','italic','fontname','times new roman','FontAngle','italic');set(gca,'YtickLabel',[],'FontSize',FontSize)
xlabel('Time (s)');
xticks = linspace(0, 1, numel(xticklabels));
set(gca, 'XTick', xticks, 'XTickLabel', xticklabels,'FontSize',FontSize,'fontname','times new roman','FontAngle','italic')    
...
text(1,5,['ss ' num2str(Subjects)], 'FontSize',FontSize,'fontname','times new roman','FontAngle','italic')
text(1.5,5,[info], 'FontSize',FontSize,'fontname','times new roman','FontAngle','italic')
...
title('(F)','Fontsize',FontSize,'fontname','times new roman','FontAngle','italic')

colorbar('southoutside','FontSize',FontSize*0.75)

%spaceplots
saveas(hfig,['D:\Mes Documents GIPSA\MATLAB\figures\CSPT\final\CSTPvsCSPvsCTP\3Subject_' num2str(Subjects) '_X' info '.tiff'])
saveas(hfig,['D:\Mes Documents GIPSA\MATLAB\figures\CSPT\final\CSTPvsCSPvsCTP\3Subject_' num2str(Subjects) '_X' info '.fig'])
...
%spaceplots
saveas(gca,['D:\Mes Documents GIPSA\MATLAB\figures\CSPT\final\CSTP_components\3Subject_' num2str(Subjects) '_components_Pz' num2str(PZs(Pzind)) '.tiff'])
saveas(gca,['D:\Mes Documents GIPSA\MATLAB\figures\CSPT\final\CSTP_components\3Subject_' num2str(Subjects) '_components_Pz' num2str(PZs(Pzind)) '.fig'])
end
end
